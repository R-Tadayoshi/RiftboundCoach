...
private:
    ...
    const CardDef def_ = [] {
        CardDef d;
        d.id = 828;
        d.def_id = R"RB(ven-041-166)RB";
        d.name = R"RB(Riven, Shattered)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-041/166)RB";
        ...
        d.ability_text = R"RB([Weaponmaster] (When you play me, you may [Equip] one of your Equipment to me for :rb_rune_rainbow: less, even if it's already attached.)When I attack, choose an enemy unit here. Deal 2 to it for each Equipment attached to me.)RB";
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-041-166-ceeaa9f3adc93e7a.png)RB";
        return d;
    }();
};
...
void register_card_828(CardRegistry& r) {
    r.registerCard(828, std::make_unique<RivenShattered>());
}
