...
private:
    const CardDef def_ = [] {
        CardDef d;
        d.id = 962;
        d.def_id = R"RB(ven-175-166)RB";
        d.name = R"RB(Jayce, Man of Progress)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-175/166)RB";
        ...
        d.ability_text = R"RB(When you play me, you may kill a friendly gear. If you do, you may play a gear with Energy cost no more than :rb_energy_7: from hand this turn, ignoring its Energy cost.)RB";
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-175-166-d703430d7f55f4f0.png)RB";
        return d;
    }();
};
...
void register_card_962(CardRegistry& r) {
    r.registerCard(962, std::make_unique<JayceManOfProgress>());
}
