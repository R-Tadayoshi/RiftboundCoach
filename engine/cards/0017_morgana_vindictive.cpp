...
private:
    ...
    const CardDef def_ = [] {
        CardDef d;
        d.id = 804;
        d.def_id = R"RB(ven-017-166)RB";
        d.name = R"RB(Morgana, Vindictive)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-017/166)RB";
        ...
        d.ability_text = R"RB([Ambush] (You may play me as a [Reaction] to a battlefield where you have units.)When you play me, deal damage to a unit equal to the damage marked on it.)RB";
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-017-166-0cc25f7e209613c9.png)RB";
        return d;
    }();
};
...
void register_card_804(CardRegistry& r) {
    r.registerCard(804, std::make_unique<MorganaVindictive>());
}
