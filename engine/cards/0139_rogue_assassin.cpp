...
private:
    ...
    const CardDef def_ = [] {
        CardDef d;
        d.id = 926;
        d.def_id = R"RB(ven-139-166)RB";
        d.name = R"RB(Rogue Assassin)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-139/166)RB";
        d.collector_number = 139;
        d.card_type = CardType::Legend;
        d.domains = {Domain::Calm, Domain::Fury};
        d.rarity = Rarity::Rare;
        d.keywords.set(Keyword::Action);
        d.ability_text = R"RB([Empower] :rb_energy_3::rb_rune_rainbow: (:rb_energy_3::rb_rune_rainbow:: Empower this. Use only if not Empowered.)[Action][>] :rb_exhaust:: If it's your turn, move a friendly unit in a showdown to base and if I'm [Empowered], ready it.)RB";
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-139-166-0261ac396ebdd3bb.png)RB";
        return d;
    }();
};
...
void register_card_926(CardRegistry& r) {
    r.registerCard(926, std::make_unique<RogueAssassin>());
}
