...
private:
    ...
    const CardDef def_ = [] {
        CardDef d;
        d.id = 923;
        d.def_id = R"RB(ven-136-166)RB";
        d.name = R"RB(Ambessa, Respected and Feared)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-136/166)RB";
        ...
        d.ability_text = R"RB([Empower] :rb_energy_1::rb_rune_order::rb_rune_order: (:rb_energy_1::rb_rune_order::rb_rune_order:: Empower me. Use only if not Empowered.)[Empowered][>] I have [Assault 2]. (+2 :rb_might: while I'm an attacker.)[Empowered][>] When I attack, kill an enemy unit here with less Might than me.)RB";
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-136-166-6ca0305f92843a91.png)RB";
        return d;
    }();
};
...
void register_card_923(CardRegistry& r) {
    r.registerCard(923, std::make_unique<AmbessaRespectedAndFeared>());
}
