...
private:
    const CardDef def_ = [] {
        CardDef d;
        d.id = 981;
        d.def_id = R"RB(ven-194-166)RB";
        d.name = R"RB(Defender of Tomorrow)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-194/166)RB";
        d.collector_number = 194;
        d.card_type = CardType::Legend;
        d.domains = {Domain::Body, Domain::Mind};
        d.rarity = Rarity::Rare;
        d.ability_text = R"RB([Empower] :rb_energy_2::rb_rune_rainbow::rb_rune_rainbow::rb_energy_1:, :rb_exhaust:: Ready a gear.[Empowered][>] :rb_energy_1:, :rb_exhaust:: Ready 2 gear.)RB";
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-194-166-f44646126741ab20.png)RB";
        return d;
    }();
};
...
void register_card_981(CardRegistry& r) {
    r.registerCard(981, std::make_unique<DefenderOfTomorrow>());
}
