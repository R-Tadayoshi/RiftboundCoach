...
private:
    const CardDef def_ = [] {
        CardDef d;
        d.id = 983;
        d.def_id = R"RB(ven-196-166)RB";
        d.name = R"RB(Matriarch of War)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-196/166)RB";
        d.collector_number = 196;
        d.card_type = CardType::Legend;
        d.domains = {Domain::Body, Domain::Order};
        d.rarity = Rarity::Rare;
        d.ability_text = R"RB(When you empower something else, empower me.Disempower me, :rb_rune_rainbow:, :rb_exhaust:: Ready a unit.)RB";
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-196-166-2df29cd4f593f210.png)RB";
        return d;
    }();
};
...
void register_card_983(CardRegistry& r) {
    r.registerCard(983, std::make_unique<MatriarchOfWar>());
}
