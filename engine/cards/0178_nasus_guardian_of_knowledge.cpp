...
private:
    const CardDef def_ = [] {
        CardDef d;
        d.id = 965;
        d.def_id = R"RB(ven-178-166)RB";
        d.name = R"RB(Nasus, Guardian of Knowledge)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-178/166)RB";
        ...
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-178-166-0483d5984ec9d54e.png)RB";
        return d;
    }();
};
...
void register_card_965(CardRegistry& r) {
    r.registerCard(965, std::make_unique<NasusGuardianOfKnowledge>());
}
