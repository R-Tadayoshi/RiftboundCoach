...
private:
    const CardDef def_ = [] {
        CardDef d;
        d.id = 938;
        d.def_id = R"RB(ven-151-166)RB";
        d.name = R"RB(Soul's Reflection)RB";
        d.set_code = R"RB(VEN)RB";
        d.set_name = R"RB(VEN)RB";
        d.public_code = R"RB(VEN-151/166)RB";
        d.collector_number = 151;
        d.card_type = CardType::Legend;
        d.domains = {Domain::Chaos, Domain::Mind};
        d.rarity = Rarity::Rare;
        d.ability_text = R"RB(When you empower something else, empower me. (I become Empowered if I'm not already.)Disempower me, :rb_exhaust:: Give a unit at a battlefield -2 :rb_might: this turn.)RB";
        d.image_url = R"RB(https://cdn.riftscribe.gg/cards/originals/ven-151-166-e6aa4b0b79f1887a.png)RB";
        return d;
    }();
};
...
void register_card_938(CardRegistry& r) {
    r.registerCard(938, std::make_unique<SoulsReflection>());
}
